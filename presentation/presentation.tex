...
\frame{
	...
	\begin{changemargin}
		\begin{itemize}
			...
			\item Notch filter
			\item Filterbank, Time-frequency transforms, Wavelet transform,
			      Multitaper filtering, \ldots
		\end{itemize}
	\end{changemargin}
...
\frame{
	\frametitle{Choosing stimulation frequencies}
	\begin {changemargin}
	Which of these SSVEP designs are suited for the EU power grid and a
	60Hz monitor?
	\begin{enumerate}
		\item 2Hz, 5Hz, 8Hz, 12Hz
		\item 13Hz, 17Hz, 21Hz
		\item 14Hz, 18Hz, 26Hz
		\item 20Hz, 30Hz, 40Hz, 50Hz
		\item 12Hz, 14Hz, 18Hz, 23Hz
		\item 6.66Hz, 7.50Hz, 8.57Hz, 10Hz, 12Hz,
		\item 10.13Hz, 11.47Hz, 12.67Hz
	\end{enumerate}
	\end{changemargin}
}
